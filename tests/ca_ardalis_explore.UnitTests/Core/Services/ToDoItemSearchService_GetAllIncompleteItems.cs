...
using ca_ardalis_explore.Core.ProjectAggregate;
using ca_ardalis_explore.Core.Services;
using ca_ardalis_explore.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace ca_ardalis_explore.UnitTests.Core.Services
{
